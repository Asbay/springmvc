...
public class StudentController {
    ...
    public String sendStudentForm(@ModelAttribute("student") Student student){
        return "studentForm";  //@ModelAttribute = model e student isminde bir attribute ekleniyor
    ...
    @GetMapping("/delete/{id}") //tek variable la calisinca @pathvariable cokvariable ile olacaksa @requestparam kullanilacak
